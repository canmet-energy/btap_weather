...
def main_program():
    ...
    input_epw_fname = ""  # name of input EPW file (if blank no header information will be copied)
    input_stat_fname = ""  # name of input STAT file (if blank no output stat file is generated)
    input_ddy_fname = ""  # name of input DDY file (if blank no output ddy file is generated)
    output_fname = "output"  # base name for output files (.epw, .stat, and .ddy)
    num_years = 0  # number of years to be read from WY3 file
    num_days = 7  # number of days to be read from WY3 file
    begin_line = 2  # This line is the first record in the WY3 file
    end_line = begin_line + num_days*24 + num_years*8760 - 1  # This line is the last record in the WY3 file
    generate_zip_file = "no"  # set to "yes" to generate zip file of output files
    # =========================================================================================================
